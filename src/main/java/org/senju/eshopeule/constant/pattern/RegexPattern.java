...
public final class RegexPattern {
    public static final String USERNAME_PATTERN = "^(?!\\d)[A-Za-z\\d]{6,25}$";
    ...
    public static final String ID_PATTERN = "^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$";
}
